...
function preload() {
  ...
  BLAST_MOON_SPIKE=loadAnimation("BLAST-MOON-SPIKE1.png","BLAST-MOON-SPIKE2.png","BLAST-MOON-SPIKE3.png","BLAST-MOON-SPIKE4.png","BLAST-MOON-SPIKE5.png","BLAST-MOON-SPIKE6.png","BLAST-MOON-SPIKE7.png","BLAST-MOON-SPIKE8.png","BLAST-MOON-SPIKE9.png","BLAST-MOON-SPIKE10.jpg","BLAST-MOON-SPIKE11.jpg","BLAST-MOON-SPIKE12.jpg","BLAST-MOON-SPIKE13.jpg");
...
function setup() {
  ...
  fuel1 = createSprite(100,200,20,20);
  fuel2 = createSprite(200,200,20,20);
  fuel3 = createSprite(300,200,20,20);

  PROTON_RIGHT = createSprite(640,307.95);
  PROTON_RIGHT.addAnimation(" ",PROTON_BLAST);
  PROTON_RIGHT.scale = 0.06;
  PROTON_RIGHT.debug = true;
  PROTON_RIGHT.setCollider("circle",8,-5,255);
  ...
  PROTON_LEFT.debug = true;
  PROTON_LEFT.setCollider("circle",8,-5,255);
  ...
  UFO.debug = true;
  UFO.setCollider("circle",1,-5,265)
  UFO.scale = 0.13;
  console.log(fuel);
}
...
function draw() {
  ...
  if(PROTON_RIGHT.isTouching(gloom_grp2)||PROTON_LEFT.isTouching(gloom_grp2))
    ...
    if(UFO.isTouching(allObs)){
      UFO.addAnimation(" ",END_STAGE_UFO);
      fuel -= 1;
      if(fuel === 3){
    ...
    allObs.setVelocityXEach(0);
    PROTON_RIGHT.destroy();
    PROTON_LEFT.destroy();
  }
    //if(UFO.isTouching(gloom_grp)||UFO.isTouching(gloom_grp2)){
      //UFO.scale =+ 1;
    //}
  ...
  //if(PROTON_RIGHT.isTouching(allObs)&&PROTON_RIGHT.y == 307.95||PROTON_LEFT.isTouching(allObs)&&PROTON_LEFT.y == 307.95){
...
function ENEMY_GLOOM() {
  GLOOM = createSprite(1300,Math.round(random(20,600)));
